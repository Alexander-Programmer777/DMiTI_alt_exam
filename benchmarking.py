...
# Добавляем все папки в путь
sys.path.append('.')  # текущая папка
sys.path.append('./N')
sys.path.append('./Z')
sys.path.append('./Q')
sys.path.append('./Matrixes')

# графики сохраняем в отдельную папку, чтобы не засорять
import os
...
def research_matmul():
    ...
    plt.legend()
    plt.savefig("graphs/mul_small.png", dpi=300, bbox_inches='tight')
    plt.show()
    ...
    plt.grid(True, alpha=0.3)
    plt.legend()
    plt.savefig("graphs/mul_total.png", dpi=300, bbox_inches='tight')
    plt.show()
...
def research_det():
    ...
    * для n <= 3 выписаны формулы, поэтому длительность работы зависит только от операций над Q
    ...
    plt.grid(True, alpha=0.3)
    plt.legend()
    plt.savefig("graphs/det_random.png", dpi=300, bbox_inches='tight')
    plt.show()
    ...
    plt.savefig("graphs/det_sparse.png", dpi=300, bbox_inches='tight')
    plt.show()
...
def research_inverse():
    ...
    plt.grid(True, alpha=0.3)
    plt.legend()
    plt.savefig("graphs/inverse.png", dpi=300, bbox_inches='tight')
    plt.show()
...
def research_pow():
    ...
    for power in powers:
        ...
        plt.grid(True, alpha=0.3)
        plt.legend()
        plt.savefig(f"graphs/pow_size_power{power}.png", dpi=300, bbox_inches='tight')
        plt.show()
    ...
    plt.grid(True, alpha=0.3)
    plt.legend()
    plt.savefig("graphs/pow_2x2_methods_general.png", dpi=300, bbox_inches='tight')
    plt.show()
    ...
    plt.grid(True, alpha=0.3)
    plt.legend()
    plt.savefig("graphs/pow_2x2_methods_special.png", dpi=300, bbox_inches='tight')
    plt.show()
    ...
    plt.grid(True, alpha=0.3)
    plt.legend()
    plt.savefig("graphs/pow_diagonal.png", dpi=300, bbox_inches='tight')
    plt.show()
...
def research_poly():
    ...
    plt.grid(True, alpha=0.3)
    plt.legend()
    plt.savefig("graphs/thick_poly.png", dpi=300, bbox_inches='tight')
    plt.show()
    ...
    plt.grid(True, alpha=0.3)
    plt.legend()
    plt.savefig("graphs/sparse_poly.png", dpi=300, bbox_inches='tight')
    plt.show()
